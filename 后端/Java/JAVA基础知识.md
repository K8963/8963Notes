...
![image-20211124214613651](JAVA基础知识.assets/image-20211124214613651.png)
...
![](JAVA基础知识.assets/202112040148122.png)

`String s = names[2];`

字符串类型变量`s`是引用类型，实际上存储的是“333”的地址

![image-20211126163306556](JAVA基础知识.assets/202112040148375.png)
...
![image-20211126163300414](JAVA基础知识.assets/image-20211126163300414.png)
